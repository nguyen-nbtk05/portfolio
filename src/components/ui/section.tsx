...
export function Section({
  ...
  return (
    <section
      ...
      data-cursor={dataCursor}
      className={cn(
        "flex min-h-[100svh] items-start pb-12 pt-[calc(5rem+env(safe-area-inset-top))] sm:pb-16 sm:pt-[calc(5rem+env(safe-area-inset-top))] lg:min-h-[100vh] lg:items-center lg:py-10",
