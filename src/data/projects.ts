export const projects = [
  {
    ...
    description: {
      ...
      vi: "Di dời thành công hệ thống mạng trung tâm dữ liệu cũ sang cấu trúc spine-leaf hiện đại bằng switch Cisco Nexus, cải thiện thông lượng 40%.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      vi: "Phát triển mã Python để tự động hóa việc cấp phát thiết bị router ở các chi nhánh, giảm thời gian cài đặt từ nhiều giờ xuống vài phút.",
    },
  ...
  },
  {
    ...
    description: {
      ...
      vi: "Thiết kế và thực thi hệ thống kết nối site-to-site IPsec VPN có tính sẵn sàng cao giữa hệ thống on-premise với AWS và Azure.",
    },
